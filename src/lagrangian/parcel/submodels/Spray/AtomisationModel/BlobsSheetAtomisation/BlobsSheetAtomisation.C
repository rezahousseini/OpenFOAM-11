...
Foam::BlobsSheetAtomisation<CloudType>::BlobsSheetAtomisation
(
...
Foam::BlobsSheetAtomisation<CloudType>::BlobsSheetAtomisation
(
    const BlobsSheetAtomisation<CloudType>& am
)
:
...
template<class CloudType>
Foam::scalar Foam::BlobsSheetAtomisation<CloudType>::initLiquidCore() const
{
    return 1.0;
}
...
template<class CloudType>
bool Foam::BlobsSheetAtomisation<CloudType>::calcChi() const
{
    return false;
}
...
template<class CloudType>
void Foam::BlobsSheetAtomisation<CloudType>::update
(
    const scalar dt,
    scalar& d,
    scalar& liquidCore,
