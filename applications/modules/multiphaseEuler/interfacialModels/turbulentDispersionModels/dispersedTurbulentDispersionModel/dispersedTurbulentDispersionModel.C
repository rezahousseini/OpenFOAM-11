...
#include "turbulentDispersionModels/dispersedTurbulentDispersionModel/dispersedTurbulentDispersionModel.H"
...
:
    ...
    interface_
    (
        interface.modelCast<turbulentDispersionModel, dispersedPhaseInterface>()
    )
{}
